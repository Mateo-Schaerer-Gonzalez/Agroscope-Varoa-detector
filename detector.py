...
class Detector:
    def __init__(self):
        self.model_path = "runs/detect/fine_tuned_varro_model/weights/best.pt"  # Path to your fine-tuned model
    ...
    def run_detection(self, image):
        ...
        result = self.model(
            ...
            batch=1,
            exist_ok=True,
            device="cuda" #comment out if you want to use CPU
        )
...
if __name__ == '__main__':
    if False:
        ...
        model = YOLO("best.pt")  # or 'varrodetector/model/weights/best.pt' if you want to continue training
